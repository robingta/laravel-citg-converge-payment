...
use CITG\ConvergePayment\Services\ConvergeQueryTransactionsService;
use Illuminate\Support\Facades\Facade;

class ConvergeQueryManager extends Facade
{
    /**
    ...
    {
        return ConvergeQueryTransactionsService::class;
    }
}